...
**Implementation authority:** **HELM-LAUNCH P1, P2, P3, P4 and P5 accepted; the complete
helm-launch 0.1 module is PRODUCT-ACCEPTED (2026-09-21).** P1
...
[authorised on 2026-09-20](../DECISIONS.md#helm-launch-p5-authorised) and
[accepted on 2026-09-21](../DECISIONS.md#helm-launch-0-1-product-accepted) after one fresh
independent whole-crate review, one bounded `P5R-01` correction and one independent rereview, with
every load-bearing hosted Linux gate green on a single natural attempt-1 run. With that decision the
complete 0.1 module is **product-accepted** at reviewed head
`dd92a85fcf0cc35306123ef2dc39adb148ddc616`.
...
**P1**; on 2026-09-18 authorised and then accepted **P2**, and authorised **P3**, the unsafe backend
and closed child contract, accepted on 2026-09-19; on 2026-09-19 authorised **P4**, the lifecycle,
public `launch` and real receipt slice, accepted on 2026-09-20; and on 2026-09-20 authorised the
final **P5** slice, accepted on 2026-09-21. **Every implementation slice of helm-launch 0.1 is
accepted and the complete module is product-accepted**, at reviewed head
`dd92a85fcf0cc35306123ef2dc39adb148ddc616`; no further implementation slice is authorised. The P1
and P2 acceptances authorise no process creation; the P3 authorisation authorises process creation
and an execution attempt **internally only**, with no public execution API and no process-group
sweep; P4 added the public `launch` API and the guarded cleanup sweep, which is best-effort cleanup
and never process-tree containment.
