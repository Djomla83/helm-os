...
**Implementation authority:** **HELM-LAUNCH P1, P2 and P3 accepted; P4 and P5 not authorised.** P1
...
review, four bounded independent correction reviews and hosted Linux x86_64 validation.
...
privilege acquisition. **Acceptance of P3 changes none of the architectural contract below**: it is
status synchronisation, not a new architecture decision.\
