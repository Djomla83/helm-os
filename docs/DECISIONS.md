...
preregistration in isolated parallel contexts, and returned nine BLOCKER findings without
...
direct-child liveness — and re-froze the experiment at **71 cases, still NOT_RUN**. **ADR-0024
stays Proposed**, no implementation or execution is authorised, D-1 through D-6 and D-8 are
recorded only provisionally, **D-7 is not authorised**, and two new owner decisions D-9 and D-10
are open. ADR-0001 through ADR-0019 remain Proposed. No other architecture acceptance follows
from this decision.
